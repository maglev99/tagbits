...
const LastDayData = React.forwardRef((props, ref: any) => {
  ...
  return (
		<div className={`${centerContainerOnly} w-[1000px] px-1 flex-wrap bg-tb-background`} ref={ref}>
    <div
      className={`${centerContainerOnly} w-[960px] px-1 pl-4 flex-wrap pb-10`}
    >
		<div className={`mt-10 ${mainFont} text-[39px] ${centerContainerOnly} w-[960px] px-4 justify-start`}>
			<h1>Top 100 most minted tags on objkt.com last day</h1>
		</div>
		<div className={`mt-2 mb-[50px] ${mainFont} text-[22px] ${centerContainerOnly} w-[960px] px-4 justify-start`}>
            ...
            .map((filteredTag: string) => (
              ...
              >
                <a
                  ...
                  className="font-sans lg:font-light mx-2 px-2 py-1 rounded-xl my-2 text-[#F3F3F3] bg-tb-text hover:underline max-w-sm truncate"
                >
                  {filteredTag}
                </a>
                {item.tags.indexOf(filteredTag) === item.tags.length - 1 && (
                  <h1 className={`${mainFont} text-xl translate-y-2`}>
					...
					<div className={`mt-10 ${mainFont} text-[32px] ${centerContainerOnly} w-[960px] px-6 justify-end`}>
			<h1>tagbits.xyz</h1>
		</div>
...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className={`${centerContainerOnly} flex w-[960px] justify-start my-12 pl-8`}>
        <button
